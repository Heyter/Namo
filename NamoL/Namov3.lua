...
//Spam, broken in the form of favourtism, but it is included anyways, beware of it.
...
//Silent Aim
// Silent aim is on always until you rejoin the server, it is yet to be fixed.
...
if GetConVarNumber("N_Silent") == 1 then 
	...
	hook.Add("Think","",function()
		if not input.IsKeyDown(KEY_G) then return end
		target = nil
...
LoadNamo(true)
	...
	//Namo Help
	concommand.Add("N_help",NamoHelp)
		function NamoHelp()
			Namo.Message ("N_help Displays the commands")
			Namo.Message ("N_360 360 noscopes someone")
			Namo.Message ("N_Pk Throws a prop using magneto stick")
			Namo.Message ("N_panic [0,1] 1 disables the cheats 0 enables") // One of these things isn't like the other
			Namo.Message ("N_spam [0,1] 1 starts the spam 0 stops it")
			Namo.Message ("N_Silent [0,1] 1 turns on psilent aim")
	end

RunConsoleCommand("cl_cmdrate", "+30") 

Namo.Message ("Cheats successfully loaded")
Namo.Message ("Type N_help for basic console commands")
